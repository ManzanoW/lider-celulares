      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 md:flex-row md:items-center md:py-24">
        ...
        <div className="relative flex-1 flex items-center justify-center">
          ...
          <div className="relative w-full overflow-hidden rounded-2xl md:rounded-3xl">
            ...
            <div
              className="absolute bottom-3 left-3 flex items-center gap-1.5 rounded-full bg-black/70 backdrop-blur-sm px-3 py-1.5 border border-white/10 cursor-pointer "
              onClick={() => scrollToId("reviews")}
            >
              <svg
                className="w-3.5 h-3.5 text-amber-400 hover:text-amber-300 transition duration-300 ease-in-out"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
